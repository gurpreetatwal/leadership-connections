 ...
 *
 * This structure also provides a very nice property in that each index appears
 * exactly twice in each row, this makes it easy to ensure that each index
 * participates no more or no less than any other index.
 *
 * Example:
 * 01 12 23 34 04
 * 02 13 24 03 14
